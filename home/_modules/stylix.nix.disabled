...

{
  ...
  } // lib.optionalAttrs ctx.host.is.gui {
    image = alnLib.relToRoot "assets/wallpaper/roadtrip.jpg";
  ...
  #   } // lib.optionalAttrs ctx.host.is.gui {
  #     image = lib.mkForce (alnLib.relToRoot "assets/wallpaper/wallpaper-day.jpg");
  #   };
