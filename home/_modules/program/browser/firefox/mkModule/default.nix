  ...
  addonModule = {
    options = {
      id = lib.mkOption {
        type = lib.types.str;
        default = "";
        description = ''name@domain or {uuid}.
      ...
      name = lib.mkOption {
        type = lib.types.str;
        default = "";
        description = ''Name of addon in mozilla store.
      ...
      installation_mode = lib.mkOption {
        type = lib.types.enum [ "allowed" "blocked" "force_installed" "normal_installed" ];
        default = "force_installed";
      };
    };
  };
  newExtendArgs = extendArgs // { inherit addonModule; };
in
{
  imports = [
